...
const AddRecipeSubCategory = () => {
    ...
    const fields = [
        ...
        // // اضافه تاريخ
        // { type: 'date', name: 'date', placeholder: 'يجب عليك ادخال التاريخ', labelName: "التاريخ", required: true, disabled: false },
