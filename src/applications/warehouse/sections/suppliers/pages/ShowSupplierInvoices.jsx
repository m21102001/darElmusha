...
const ShowSupplierInvoices = () => {
  ...
  useEffect(() => {
    const getSupplier = async () => {
      ...
      console.log('useeeeeeeeeeeeeeeeeeeeeeeeeer', user)
  ...
  const detailsHeaders = [
    ...
    },
    {
      ...
      details: [
        ...
        { key: 'image', label: "صورة الفاتورة", isImage: user?.department?.image }
      ],
    },
  ];
  console.log("detailsHeaders", detailsHeaders);
